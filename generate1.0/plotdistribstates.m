...
%PLOTDISTRIB Affiche la repartition de la proportion de temps passe dans
%chaque activite au cours de la journee, entre les donnees reelles et les
%donnees simulees

% t : tableau des temps
% realdata : tableau des proportions des temps passes pour les donnees
% reelles
% stdrealdata : tableau des ecarts-types des proportions des temps passes
% pour les donnees reelles
% simulateddata/stdsimulateddata : idem mais pour les donnees simulees
    confintreal = 1.96*stdrealdata/sqrt(length(realdata)); % intervalle de confiance a 95%
